### Perform differential abundance analysis using a generalized linear model on total sum scaled abundances
...
write.table(results, "../../Script_Output/Dataset1_Output/GLM_TSS_10%.txt", quote = F, sep="\t", row.names = F)
