### Perform differential abundance testing using Kruskal-Wallis rank-sum test on total sum scaled abundances
...
# Write out results
write.table(results, "../../Script_Output/Dataset1_Output/KW_TSS_10%.txt", quote = F, sep="\t", row.names = F)
