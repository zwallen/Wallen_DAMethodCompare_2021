### Perform differential abundance testing using using Welch's t-test on total sum scaled abundances
...
# Write out results
write.table(results, "../../Script_Output/Dataset1_Output/t_test_TSS_10%.txt", quote = F, sep="\t", row.names = F)
