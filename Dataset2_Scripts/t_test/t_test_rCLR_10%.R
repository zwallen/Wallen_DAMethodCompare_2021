### Perform differential abundance testing using using Welch's t-test on robust clr transformed abundances
...
# Write out results
write.table(results, "../../Script_Output/Dataset2_Output/t_test_rCLR_10%.txt", quote = F, sep="\t", row.names = F)
