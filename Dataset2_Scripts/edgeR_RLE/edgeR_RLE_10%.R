### Perform differential abundance testing using edgeR exactTest with RLE calculated scaling factors
...
# Write out results
write.table(result.table, "../../Script_Output/Dataset2_Output/edgeR_RLE_10%.txt", row.names = F, quote = F, sep = '\t') 
