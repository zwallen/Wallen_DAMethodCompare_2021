...
write.table(lefse.df, "../../Script_Output/Dataset2_Output/LEfSe_input.txt", quote = F, sep="\t", row.names = F, col.names = F)
...
system("lefse-format_input.py ../../Script_Output/Dataset2_Output/LEfSe_input.txt ../../Script_Output/Dataset2_Output/LEfSe_input.in -c 1 -s -1 -u 2 -o 1000000")

# Run LEfSe using default parameters
system("run_lefse.py ../../Script_Output/Dataset2_Output/LEfSe_input.in ../../Script_Output/Dataset2_Output/LEfSe.txt")

# Run LEfSe using parameters that will output all LDA scores and pvalues
system("run_lefse.py ../../Script_Output/Dataset2_Output/LEfSe_input.in ../../Script_Output/Dataset2_Output/LEfSe_full.txt -a 1.0 -w 1.0 -l 0.0")

# Clean up input files
system("rm ../../Script_Output/Dataset2_Output/LEfSe_input.txt")
system("rm ../../Script_Output/Dataset2_Output/LEfSe_input.in")

##########################

# Read in results
lefse.results <- read.table("../../Script_Output/Dataset2_Output/LEfSe.txt", sep="\t")
lefse.results.full <- read.table("../../Script_Output/Dataset2_Output/LEfSe_full.txt")
...
write.table(lefse.results, "../../Script_Output/Dataset2_Output/LEfSe.txt", quote = F, sep="\t", row.names = F)
system("rm ../../Script_Output/Dataset2_Output/LEfSe_full.txt")
